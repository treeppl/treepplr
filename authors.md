...
- **Mariana P Braga**. Author, maintainer.
...
P Braga M (2026). *treepplr: R Interface to TreePPL*. R package version
0.11.0, <https://github.com/treeppl/treepplr>.

    @Manual{,
      title = {treepplr: R Interface to TreePPL},

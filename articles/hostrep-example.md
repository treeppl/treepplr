...
Now we can compile and run the TreePPL program using the default
inference options.
...
The output from *tp_parse_host_rep()* contains all information outputted
by treeppl, so we need to separate the sampled character histories from
...
![](hostrep-example_files/figure-html/unnamed-chunk-7-1.png)
...
![](hostrep-example_files/figure-html/unnamed-chunk-7-2.png)
...
This table can be used by **evolnets** for plotting results, together
with the phylogenetic trees and the known extant interactions.
...
![](hostrep-example_files/figure-html/unnamed-chunk-10-1.png)
...
![](hostrep-example_files/figure-html/unnamed-chunk-11-1.png)
